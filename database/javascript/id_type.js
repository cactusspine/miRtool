...
*/
	...
	addOption(category_selectbox, "mirbase_accession", "miRBase Accession ID", "");
	...
	addOption(category_selectbox, "refseq_id", "Refseq Transcript ID");
...
*/
	...
	if((category_selectbox_value == 'mirbase_name')||(category_selectbox_value == 'mirbase_accession')) {
	...
	if((category_selectbox_value == 'ensembl_gene_id')||
	   ...
	   (category_selectbox_value == 'refseq_id')
          ) {
		addOption(selectbox, "mirbase_accession", "miRNAs");
	}
