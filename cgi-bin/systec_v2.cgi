...
HEREDOCEND
    ...
    if(($input_type eq "mirbase_name")||($input_type eq "mirbase_accession")) {
        ...
        $heredoc = <<"HEREDOCEND";
                                     <tr>
                                 <td>Nr. of Input microRNA</td><td>$input_nr</td>
                             </tr>
                             <tr>
                                 <td>Nr. of Analysed microRNA</td><td>$input_nr</td>
                             </tr>
                             <tr>
                                 <td>Nr. of Output microRNA molecules</td><td>$size <a href=\"$session_output_url\"><b>download Result</b></a><br><img alt="expand" src='http://bio1.uni.lu:8081/mirna/database/images/plus.gif' id="expand" class="toclick"> Expand All <img alt="collapse" src='http://bio1.uni.lu:8081/mirna/database/images/minus.gif' id="collapse" class="toclick">Collapse All
                                 </td>
                             </tr>
                                 <tr>
                                 <td>Nr. of Prediction Tools/EvidenceDBs</td><td>$db_nr</td>
                             </tr>
                                 <tr>
                                 <td>Advanced Parameters(Minimum Priority)</td><td>3</td>
                             </tr>
                         </table><!--#factsheet-->
<br>
<ul class="accordion">
HEREDOCEND
        ...
        ##################################
                $heredoc = <<"HEREDOCEND";
                                     <tr>
                                 <td>Nr. of Input mRNA</td><td>$input_nr</td>
                             </tr>
                             <tr>
                                 <td>Nr. of Analysed mRNA</td><td>$input_nr</td>
                             </tr>
                             <tr>
                                 <td>Nr. of Output microRNA molecules</td><td>$size <a href=\"$session_output_url\"><b>download Result</b></a><br><img alt="expand" src='http://bio1.uni.lu:8081/mirna/database/images/plus.gif' id="expand" class="toclick"> Expand All <img alt="collapse" src='http://bio1.uni.lu:8081/mirna/database/images/minus.gif' id="collapse" class="toclick">Collapse All
                                 </td>
...
#http://www.mirbase.org/cgi-bin/mirna_entry.pl?acc=MI0000651
        print "<li><label for=\'$toggle\' class=\"toclick\">#miRNA: <a class=biocompendium href=\"http://www.mirbase.org/cgi-bin/mirna_entry.pl?acc=$mirna_name\">$mirna_name</a></label>\n";
        ...
        foreach my $current_field (@fields){
            if ($current_field=~'tarbase'){
                print  "<th class=\"smallCell\" bgcolor=\"#000000\"><div id=\'smallCell\' class=\"verticalText\">$current_field</div></th>\n";
            }else{
                print  "<th class=\"smallCell\"><div id=\'smallCell\'class=\"verticalText\">$current_field</div></th>\n";}  
        }
...
sub sub_table_view_gene_centric_new {
    ...
    foreach my $refseq_name (@keys) {
        ...
        foreach my $mirna_name (sort {$sorted_target_hash{$b}<=>$sorted_target_hash{$a}} keys %sorted_target_hash) {
            ####################################
            $target_details .= "<tr>\n";
            $target_details .= "<td class=\"bigcell\"><a class=biocompendium href=\"http://www.mirbase.org/cgi-bin/mirna_entry.pl?acc=$mirna_name\">$mirna_name</a></td>\n";
