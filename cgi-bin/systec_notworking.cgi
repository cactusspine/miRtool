...
my @toolselection = $q->param("toolselection");#trace tool selected#0110
my %toolselection;
if(!$position) {
    $position = "";
}
...
if(!$text_area_ids) {
    $text_area_ids = "PDGFRA";#for testing
}
if(!@toolselection){
...
$q->start_html( -title=>'Systec:FANCI database',
    ...
    -style=>{-src=>[
            #'http://rschneider.embl.de/systec/database/style/systec.css', 
            #'http://rschneider.embl.de/systec/database/style/systec_popup.css'
            $URL_project.'mirna/database/style/systec.css',#0110
            $URL_project.'mirna/database/style/systec_popup.css',#0110
            $URL_project.'mirna/database/style/uorfdb.css'#0110
    ...
    -script=>[
        ...
        # {-language=>'JAVASCRIPT', -src=>'http://rschneider.embl.de/systec/database/javascript/checkboxes.js'},#0110
        {-language=>'JAVASCRIPT', -src=> $URL_project.'mirna/database/javascript/checkboxes.js'},#0110
        
        {-language=>'JAVASCRIPT', -src=> $URL_project.'mirna/database/javascript/sorttable.js'}#0110#import the sortable function
    ],
...
#print "input_type : $input_type, org : $org, file : $file<br>";
        ...
        #print "primary gene_list from id file : @gene_list\n";#testing
...
&table_view(0, $session, $input_type, 'mirna_name', 'desc',$org,$session_dir);#position, $session, $input_type,$sort_by_field_name,$asc or desc
} # sub process_genelists {
...
sub table_view {
    my ($position, $session, $input_type, $sort_by_field_name, $asc_or_desc,$org,$session_dir) = @_;
...
#print "session : $session<br>";#testing
#print "org : $org<br>";#testing
#print "list_name : $list_name<br>";#testing
#print "input_type : $input_type<br>";#testing
    my $result_hash = undef;
    my %result_hash;
    my %table_hash;

    if($input_type eq "mirbase_name"||$input_type eq "mirbase_accession") {
        $result_hash = &DbmiRNA::GetMirTableViewInfo($input_type, $asc_or_desc, $session, $list_name,$query_db,$session_dir);#field_name,asse or desc, $temp_database,$tmp_table,$query_database
        #%result_hash=%$result_hash;
        # %table_hash=%{$result_hash->{'mirna_hash'}};
    }
    else {
        $result_hash = &DbmiRNA::GetTargetTableViewInfo($input_type, $asc_or_desc, $session, $list_name,$query_db,$session_dir);
...
sub sub_table_view_new {
    ...
    foreach my $mirna_name (@keys) {
        ...
        foreach my $transcript_id (sort {$sorted_target_hash{$b}<=>$sorted_target_hash{$a}} keys %sorted_target_hash) {
            #print "$mirna_name,$transcript_id,$sorted_target_hash{$transcript_id}\n";
            my $bg;
            if($i%2==0) {
                $bg="#D4EDF4";
            }
            ...
            $target_details .= "<td><a class=biocompendium href=\"http://www.ncbi.nlm.nih.gov/nuccore/$transcript_id\">$transcript_id</a></td>\n";                            
            ...
            $target_details .= "</tr>\n";#one line finished
        } # foreach my $transcript_id (sort {$sorted_target_hash{$a}<=>$sorted_target_hash{$b}} keys %sorted_target_hash) {#each line in the subtable
                          
        print "<tbody><tr>\n";
        my $toggle = "target" . $mirna_name;
        $imgNo++;
#http://www.mirbase.org/cgi-bin/mirna_entry.pl?acc=MI0000651
        print "<td colspan=2 width=\"12%\" bgcolor= #dcdcdc><a href=\"#\" onclick=\"return toggleItem(\'$toggle\')\"><img alt=\"\" src=\"/images/plus.gif\" name=\'img$imgNo\' onClick=\'changeImage(\"img$imgNo\")\'></a><font face=\"Arial\" size=\"2\" color=\"#000000\"><b>#miRNA: <a class=biocompendium href=\"http://www.mirbase.org/cgi-bin/mirna_entry.pl?acc=$mirna_name\">$mirna_name</a></b></font></td>\n</tr>\n";
        #print "<div id=$mirna_name class="tableContainer"><table class= "sortable" width="100%" border=0 cellpadding=0>";#0110# 
        print "</tbody>";
        print "<div class=\"collapse_obj\" id=\"$toggle\">\n";#for toggle collapse
        print "<div class=\"tableContainer\">\n<table class=\"sortable\" width=\"100%\" cellspacing= \"0\" border=\"0\">\n";       
        print "<thead class =\"fixedHeader\"><tr><th bgcolor= #c7c7d0><div class=\"verticalText\"><b>refseq transcript ID </b></div></th>\n";
        foreach my $current_field (@fields){
            if ($current_field=~'tarbase'){
                print  "<th bgcolor= #FFFF00><div class=\"verticalText\">$current_field</div></th>\n";
            }else{
                print  "<th bgcolor= #c7c7d0><div class=\"verticalText\">$current_field</div></th>\n";
            }  
        }
        print "<th bgcolor= #c7c7d0><div class=\"verticalText\">Priority </div></th>\n";
        print "</tr>\n</thead>\n";
        print "<tbody class = \"scrollContent\">\n>";
        print "$target_details";
        print "<tr><td>&nbsp;</td><td></td></tr>";#empty line
        print "</tbody>\n";        
        print "</table>\n</div>\n</div>\n";#close table, div table Container,div collapse
...
sub sub_table_view_gene_centric_new {
    ...
    print "<tr>\n";
    print "<td class=light_blue width=12><font face=\"Arial\" size=\"2\" color=\"#000000\"><b>Description</b></font></td>\n";
    print "<td><font face=\"Arial\" size=\"2\" color=\"#000000\"><b>Details of the input transcript lists</b></font><br></td>\n";
    print "</tr>\n";
    print "<tr>\n";
    print "<td class=light_blue><font face=\"Arial\" size=\"2\" color=\"#000000\"></font></td>\n";
    print "<td><br><a href=\"#\" onclick=\"return toggleAll(\'expand\')\"><img alt=\"\" src=\"/images/plus.gif\" name=\'expand\' onClick=\'changeImage(\"expand\")\'></a> <font face=\"Arial\" size=\"2\" color=\"#000000\"><b>Expand All</b></font><a href=\"#\" onclick=\"return toggleAll(\'collapse\')\"> <img alt=\"\" src=\"/images/minus.gif\" name=\'collapse\' onClick=\'changeImage(\"collapse\")\'></a> <font face=\"Arial\" size=\"2\" color=\"#000000\"><b>Collapse All</b></font><br></td>\n";
    ...
    foreach my $refseq_name (@keys) {
        ...
        foreach my $mirna_name (sort {$sorted_target_hash{$b}<=>$sorted_target_hash{$a}} keys %sorted_target_hash) {
            #print "$refseq_name,$mirna_name,$sorted_target_hash{$mirna_name}\n";
            my $bg;
            if($i%2==0) {
                $bg="#D4EDF4";
            }
            ...
            $target_details .= "<tr bgcolor=\"$bg\">\n";
            $target_details .= "<td><a class=biocompendium href=\"http://www.mirbase.org/cgi-bin/mirna_entry.pl?acc=$mirna_name\">$mirna_name</a></td>";                            
        ...
        $imgNo++;
#http://www.mirbase.org/cgi-bin/mirna_entry.pl?acc=MI0000651
        print "<td colspan=2 width=\"12%\" bgcolor= #dcdcdc><a href=\"#\" onclick=\"return toggleItem(\'$toggle\')\"><img alt=\"\" src=\"/images/plus.gif\" name=\'img$imgNo\' onClick=\'changeImage(\"img$imgNo\")\'></a><font face=\"Arial\" size=\"2\" color=\"#000000\"><b>#Refseq transcript ID <a class=biocompendium href=\"http://www.ncbi.nlm.nih.gov/nuccore/$refseq_name\">$refseq_name</a></font></td>\n";
        ...
        print "<thead class=\"fixedHeader\"><tr>\n";
        print "<th bgcolor= #c7c7d0><div class=\"verticalText\">Mirbase Accession </div></th>\n";
        foreach my $current_field (@fields){
            if ($current_field=~'tarbase'){
                print  "<th bgcolor= #FFFF00><div class=\"verticalText\">$current_field</div></th>\n";
            }else{
        ...
        print "</tbody>\n";
        print "</table>\n</div>\n</div>\n";#close table div table Container 
    } # foreach my $cluster_id (@cluster_ids) {
    print "</table>\n";
    print "<br></td>";
    print "</tr>\n";
...
sub sub_table_view_new {
    ...
    foreach my $mirna_name (@keys) {
        ...
        foreach my $transcript_id (sort {$sorted_target_hash{$b}<=>$sorted_target_hash{$a}} keys %sorted_target_hash) {
            ...
            $target_details .= "<tr bgcolor=\"$bg\">\n";
            $target_details .= "<td><font face=\"Arial\" size=\"2\" color=\"#000000\"><a class=biocompendium href=\"http://www.ncbi.nlm.nih.gov/nuccore/$transcript_id\">$transcript_id</a></font></td>\n";                            
            foreach my $current_stat (@{$table_hash{$mirna_name}{$transcript_id}}){
                $target_details .= "<td><font face=\"Arial\" size=\"2\" color=\"#000000\">$current_stat</font></td>\n";
            }
            $target_details .= "<td><font face=\"Arial\" size=\"2\" color=\"#000000\">$priority_hash{$mirna_name}{$transcript_id}</font></td>\n";
            $target_details .= "</tr>\n";
        } # foreach my $transcript_id (sort {$sorted_target_hash{$a}<=>$sorted_target_hash{$b}} keys %sorted_target_hash) {
        print "<tbody>";
        print "<tr>\n";
        ...
        $imgNo++;
#http://www.mirbase.org/cgi-bin/mirna_entry.pl?acc=MI0000651
        print "<td colspan=2 width=\"12%\" bgcolor= #dcdcdc><a href=\"#\" onclick=\"return toggleItem(\'$toggle\')\"><img alt=\"\" src=\"/images/plus.gif\" name=\'img$imgNo\' onClick=\'changeImage(\"img$imgNo\")\'></a><font face=\"Arial\" size=\"2\" color=\"#000000\"><b>#miRNA: <a class=biocompendium href=\"http://www.mirbase.org/cgi-bin/mirna_entry.pl?acc=$mirna_name\">$mirna_name</a></b></font>";
        print "</td>\n";
        print "</tr>\n";
        #print "<div id=$mirna_name class="tableContainer"><table class= "sortable" width="100%" border=0 cellpadding=0>";#0110# 
        print "</tbody>";
        print "<tbody class=\"collapse_obj\" id=\"$toggle\">\n";
        print "<tr>\n";
        print "<td bgcolor= #c7c7d0><font face=\"Arial\" size=\"2\" color=\"#000000\"><b>refseq transcript ID </b></font></td>\n";
        foreach my $current_field (@fields){
            if ($current_field=~'tarbase'){
                print  "<td bgcolor= #FFFF00><font face=\"Arial\" size=\"2\" color=\"#000000\"><b>$current_field</b></font></td>\n";
            }else{
                print  "<td bgcolor= #c7c7d0><font face=\"Arial\" size=\"2\" color=\"#000000\"><b>$current_field</b></font></td>\n";}  
        }
...
sub sub_table_view_gene_centric_new {
    ...
    foreach my $refseq_name (@keys) {
        ...
        foreach my $mirna_name (sort {$sorted_target_hash{$b}<=>$sorted_target_hash{$a}} keys %sorted_target_hash) {
            ...
            $target_details .= "<tr bgcolor=\"$bg\">\n";
            $target_details .= "<td><font face=\"Arial\" size=\"2\" color=\"#000000\"><a class=biocompendium href=\"http://www.mirbase.org/cgi-bin/mirna_entry.pl?acc=$mirna_name\">$mirna_name</a></b></font>";                            
            foreach my $current_stat (@{$table_hash{$refseq_name}{$mirna_name}}){
                $target_details .= "<td><font face=\"Arial\" size=\"2\" color=\"#000000\">$current_stat</font></td>\n";
            }
            $target_details .= "<td><font face=\"Arial\" size=\"2\" color=\"#000000\">$priority_hash{$refseq_name}{$mirna_name}</font></td>\n";
            $target_details .= "</tr>\n";
        } # foreach my $transcript_id (sort {$sorted_target_hash{$a}<=>$sorted_target_hash{$b}} keys %sorted_target_hash) {
        print "<tbody>";
        print "<tr>\n";
...
#http://www.mirbase.org/cgi-bin/mirna_entry.pl?acc=MI0000651
        ...
        print "<tbody class=\"collapse_obj\" id=\"$toggle\">\n";
        print "<tr>\n";
        print "<td bgcolor= #c7c7d0><font face=\"Arial\" size=\"2\" color=\"#000000\"><b>Mirbase Accession </b></font></td>\n";
        foreach my $current_field (@fields){
            if ($current_field=~'tarbase'){
                print  "<td bgcolor= #FFFF00><font face=\"Arial\" size=\"2\" color=\"#000000\"><b>$current_field</b></font></td>\n";
            }else{
