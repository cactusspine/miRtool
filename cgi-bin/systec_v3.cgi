...
#print "input_type : $input_type<br>";#testing
    ...
    if($input_type eq "mirbase_name"||$input_type eq "mirbase_accession") {
        $result_hash = &DbmiRNA::GetMirTableViewInfo($input_type, $asc_or_desc, $session, $list_name,$query_db,$session_dir,\%toolselection);#field_name,asse or desc, $temp_database,$tmp_table,$query_database
        #%result_hash=%$result_hash;
        # %table_hash=%{$result_hash->{'mirna_hash'}};
    }
    else {
        $result_hash = &DbmiRNA::GetTargetTableViewInfo($input_type, $asc_or_desc, $session, $list_name,$query_db,$session_dir,\%toolselection);#pass the tool selection to file
...
HEREDOCEND
    ...
    if(($input_type eq "mirbase_name")||($input_type eq "mirbase_accession")) {
        ...
        $heredoc = <<"HEREDOCEND";
                             ...
                             <tr>
                                 <td>Nr. of Analysed microRNA</td><td>$size</td>
                             </tr>
...
HEREDOCEND
        ...
        ##################################
                $heredoc = <<"HEREDOCEND";
                             ...
                             <tr>
                                 <td>Nr. of Analysed mRNA</td><td>$size</td>
                             </tr>
